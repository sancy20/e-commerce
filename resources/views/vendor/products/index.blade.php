...
@section('content')
    <div class="flex justify-between items-center mb-4">
        ...
        <a href="{{ route('vendor.products.create') }}" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Add New Product</a>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                ...
                @empty
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-center text-gray-500">You have no products yet.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
