...
@section('content')
    <div class="flex justify-between items-center mb-4">
        <h1 class="text-2xl font-bold">Product Details: {{ $product->name }}</h1>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <div class="flex items-center mt-6">
            <a href="{{ route('vendor.products.edit', $product->id) }}" class="bg-indigo-500 hover:bg-indigo-700 text-white font-bold py-2 px-4 rounded mr-2">Edit</a>
