...
@section('content')
    ...
    <div class="bg-white shadow-md rounded-lg p-6 mb-8">
        ...
        <form action="{{ route('vendor.inquiries.index') }}" method="GET" class="grid grid-cols-1 md:grid-cols-3 gap-4 items-end">
            <div>
            ...
            <div>
                ...
                <a href="{{ route('vendor.inquiries.index') }}" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded ml-2">Reset</a>
            </div>
        </form>
    </div>
    ...
    <div class="bg-white shadow-md rounded-lg p-6">
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
                @forelse ($inquiries as $inquiry)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <a href="{{ route('vendor.inquiries.show', $inquiry->id) }}" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                            <form action="{{ route('vendor.inquiries.destroy', $inquiry->id) }}" method="POST" class="inline-block" onsubmit="return confirm('Are you sure you want to delete this inquiry?');">
                                @csrf
                                @method('DELETE')
                ...
                @empty
                    <tr>
                        <td colspan="8" class="px-6 py-4 text-center text-gray-500">No inquiries found.</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
